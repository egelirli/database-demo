...
import com.egelirli.spring.databese.databasedemo.springdata.SpringDataRepository;
...
public class SpringDataDemoApplication  implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		logger.info("All Person List: {}", repo.findAll() );
		logger.info("Person(10001): {}", repo.findById(10001) );
//		logger.info("Deleting Person(10001) - Number Of Rows Deleted {}", personDao.deletePersonById(10001) );
//		
		logger.info("Inserting  Person -  {}", 
				                     repo.save( new Person("Cangu", "Calcutta", new Date())) );
		logger.info("Updating  Person - {}", 
                               repo.save(new Person("Kangu", "Calcutta", new Date())) );
